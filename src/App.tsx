...
function AppShell() {
    // ✅ Fix: assign the translation hook to avoid unused variable warnings
    const { t } = useTranslation();
    const navigate = useNavigate();

    const { userData, loading, isAuthenticated, isCustomer, logout } =
        useAuthContext();
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-emerald-50">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">{t("loading", "Loading EnergyLink Pro...")}</p>
                </div>
            </div>
        );
    }

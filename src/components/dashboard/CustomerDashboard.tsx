...
function toElectrician(e: any): Electrician {
  // Your Firestore docs use: displayName, photoURL, location {lat,lng}, specialties, etc.
  return {
    id: e.uid || e.id,
    ...
    // your types file says string, so keep it safe:
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // optional: hide electricians with no name
